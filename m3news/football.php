...
<body class="footballpage">
	...
	<ul id="navfootball">
		...
		<li class="home" ><a class="home" href="football.php">Football</a></li>
	...
	<div class="footback">
		<img class="footback" src="football.jpg">
	</div>
<?php
    if(isset($_SESSION['user name']))
	{
...
?>
	<?php
	    if(isset($_SESSION['user name']))
	{
		$sql ="SELECT * FROM `news` WHERE `department` LIKE 'football' ORDER BY `id` DESC;";
