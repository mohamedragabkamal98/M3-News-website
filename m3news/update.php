...
<body>
	...
	<div class="postdiv">
	   <form class="postform" method="POST"  action="updatevertify.php" >
	   	<p class="s">Subject of the post you want to update</p>
		<textarea id="subject" class="subject" name="subject" placeholder="Enter The Subject"></textarea>
	   	<p class="s">New Subject</p>
		<textarea id="subject" class="subject" name="newsubject" placeholder="Enter New The Subject"></textarea>
		<p class="c">the new Content</p>
		<textarea id="content" class="content" name="content" placeholder="Enter The New Content Of The News"></textarea>
		<br>
		...
		<br>
        <input type="submit" name="update" value="UPDATE" class="post">
	   </form>
    </div>
